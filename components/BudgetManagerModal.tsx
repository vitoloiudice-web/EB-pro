...
const BudgetManagerModal: React.FC<BudgetManagerModalProps> = ({ isOpen, onClose, categories }) => {
  ...
  const handleGlobalSave = () => {
    ...
    setSuccess("Richiesta di revisione budget inviata con successo!");
    setTimeout(() => {
        setSuccess(null);
        onClose();
    }, 2000);
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-slate-900/40 backdrop-blur-sm p-4 animate-fade-in">
      ...
      <div className="bg-[#EEF2F6] w-full max-w-3xl rounded-2xl shadow-2xl overflow-hidden flex flex-col max-h-[95vh] sm:max-h-[85vh]">
