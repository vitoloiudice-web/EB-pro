...
const App: React.FC = () => {
  ...
  const renderContent = () => {
    switch (currentView) {
      ...
      case ViewState.CICLO_PASSIVO: // Was PURCHASING
        return <Purchasing tenantId={currentTenantId} isMultiTenant={isMultiTenant} />;
      case ViewState.CONTROLLO_QUALITA: // Was QUALITY
