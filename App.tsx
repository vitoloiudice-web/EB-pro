  ...
  const renderContent = () => {
    switch (currentView) {
      ...
      case ViewState.BUDGET:
        return <BudgetView client={activeWorkspace} onNavigate={navigateTo} />;
            ...
            <nav className="flex-1 overflow-y-auto pr-2 custom-scrollbar">
               ...
               <div className="space-y-1">
                 ...
                 <SidebarNavItem 
                   ...
                   tooltip={{
                      title: "Gestione Budget Clienti",
                      description: "Monitoraggio dei plafond finanziari assegnati dai clienti con vincoli temporali e merceologici.",
                      usage: "Punto di partenza per il controllo di gestione e lo stato 'Assegnato' in Dashboard."
                   }}
                 />
